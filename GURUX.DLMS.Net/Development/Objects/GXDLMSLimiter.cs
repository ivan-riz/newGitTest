...
namespace Gurux.DLMS.Objects
{
    public class GXDLMSLimiter : GXDLMSObject, IGXDLMSBase
    {
        ...
        /// </summary>
        public uint MinOverThresholdDuration
        {
            get;
            set;
        }
        ...
        /// </summary>
        public uint MinUnderThresholdDuration
        {
            get;
            set;
        }
        ...
        public ushort[] EmergencyProfileGroupIDs
        {
            get;
            set;
        }
        ...
        void IGXDLMSBase.SetValue(GXDLMSSettings settings, ValueEventArgs e)
        {
            ...
            else if (e.Index == 8)
            {
                ...
                EmergencyProfile.ID = (ushort)tmp[0];
                ...
                EmergencyProfile.Duration = (uint)tmp[2];
            }
            else if (e.Index == 9)
            {
        ...
        void IGXDLMSBase.Load(GXXmlReader reader)
        {
            ...
            MinOverThresholdDuration = (ushort)reader.ReadElementContentAsInt("MinOverThresholdDuration");
            MinUnderThresholdDuration = (ushort)reader.ReadElementContentAsInt("MinUnderThresholdDuration");
            if (reader.IsStartElement("EmergencyProfile", true))
            {
                EmergencyProfile.ID = (ushort)reader.ReadElementContentAsInt("ID");
                EmergencyProfile.ActivationTime = (GXDateTime)reader.ReadElementContentAsObject("Time", new GXDateTime());
                EmergencyProfile.Duration = (ushort)reader.ReadElementContentAsInt("Duration");
            ...
            if (reader.IsStartElement("ActionOverThreshold", true))
            {
                ...
                ActionOverThreshold.ScriptSelector = (ushort)reader.ReadElementContentAsInt("ScriptSelector");
            ...
            if (reader.IsStartElement("ActionUnderThreshold", true))
            {
                ...
                ActionUnderThreshold.ScriptSelector = (ushort)reader.ReadElementContentAsInt("ScriptSelector");
        ...
        void IGXDLMSBase.Save(GXXmlWriter writer)
        {
            ...
            if (EmergencyProfileGroupIDs != null)
            {
                ...
                foreach (ushort it in EmergencyProfileGroupIDs)
                {
