...
namespace Gurux.DLMS.Objects
{
    ...
    public class GXDLMSSFSKPhyMacSetUp : GXDLMSObject, IGXDLMSBase
    {
        ...
        [XmlIgnore()]
        public ushort[] MacGroupAddresses
        {
            get;
            set;
        }
        ...
        void IGXDLMSBase.Load(GXXmlReader reader)
        {
            ...
            MarkFrequency = (uint)reader.ReadElementContentAsInt("MarkFrequency");
            SpaceFrequency = (uint)reader.ReadElementContentAsInt("SpaceFrequency");
            MacAddress = (ushort)reader.ReadElementContentAsInt("MacAddress");
            List<ushort> list = new List<ushort>();
            ...
            InitiatorMacAddress = (ushort)reader.ReadElementContentAsInt("InitiatorMacAddress");
