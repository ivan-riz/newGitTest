...
namespace Gurux.DLMS.Objects
{
    public class GXDLMSG3PlcMacLayerCounters : GXDLMSObject, IGXDLMSBase
    {
        ...
        /// </remarks>
        [XmlIgnore()]
        public uint TxDataBroadcastCount
        {
            get;
            set;
        }
        ...
        /// </remarks>
        [XmlIgnore()]
        public uint RxDataBroadcastCount
        {
            get;
            set;
        }
        ...
        {
            TxDataPacketCount = (ushort)reader.ReadElementContentAsInt("TxDataPacketCount");
            RxDataPacketCount = (ushort)reader.ReadElementContentAsInt("RxDataPacketCount");
            TxCmdPacketCount = (ushort)reader.ReadElementContentAsInt("TxCmdPacketCount");
            RxCmdPacketCount = (ushort)reader.ReadElementContentAsInt("RxCmdPacketCount");
            CSMAFailCount = (ushort)reader.ReadElementContentAsInt("CSMAFailCount");
            CSMANoAckCount = (ushort)reader.ReadElementContentAsInt("CSMANoAckCount");
            BadCrcCount = (ushort)reader.ReadElementContentAsInt("BadCrcCount");
            TxDataBroadcastCount = (ushort)reader.ReadElementContentAsInt("TxDataBroadcastCount");
            RxDataBroadcastCount = (ushort)reader.ReadElementContentAsInt("RxDataBroadcastCount");
        }
