...
namespace Gurux.DLMS.Objects
{
    public class GXDLMSMBusClient : GXDLMSObject, IGXDLMSBase
    {
        ...
        void IGXDLMSBase.Load(GXXmlReader reader)
        {
            ...
            CapturePeriod = (ushort)reader.ReadElementContentAsInt("CapturePeriod");
            PrimaryAddress = reader.ReadElementContentAsInt("PrimaryAddress");
            IdentificationNumber = (ushort)reader.ReadElementContentAsInt("IdentificationNumber");
            ManufacturerID = (ushort)reader.ReadElementContentAsInt("ManufacturerID");
