...
namespace Gurux.DLMS.Objects
{
    ...
    public class GXDLMSSFSKMacCounters : GXDLMSObject, IGXDLMSBase
    {
        ...
        /// </summary>
        [XmlIgnore()]
        public List<KeyValuePair<ushort, uint>> SynchronizationRegister
        {
            get;
            set;
        }
        ...
        public uint PhysicalLayerDesynchronization
        {
            get;
            set;
        }
        public uint TimeOutNotAddressedDesynchronization
        {
            get;
            set;
        }
        public uint TimeOutFrameNotOkDesynchronization
        {
            get;
            set;
        }
        public uint WriteRequestDesynchronization
        {
            get;
            set;
        }
        public uint WrongInitiatorDesynchronization
        {
            get;
            set;
        }
        ...
        /// </summary>
        [XmlIgnore()]
        public List<KeyValuePair<ushort, uint>> BroadcastFramesCounter
        {
            get;
            set;
        }
        ...
        /// </summary>
        [XmlIgnore()]
        public uint RepetitionsCounter
        {
            get;
            set;
        }
        ...
        /// </summary>
        [XmlIgnore()]
        public uint TransmissionsCounter
        {
            get;
            set;
        }
        ...
        /// </summary>
        [XmlIgnore()]
        public uint CrcOkFramesCounter
        {
            get;
            set;
        }
        ...
        /// </summary>
        [XmlIgnore()]
        public uint CrcNOkFramesCounter
        {
            get;
            set;
        }
        ...
        void IGXDLMSBase.Load(GXXmlReader reader)
        {
            ...
            if (reader.IsStartElement("SynchronizationRegisters", true))
            {
                while (reader.IsStartElement("Item", true))
                {
                    ...
                    uint v = (uint)reader.ReadElementContentAsInt("Value");
                    SynchronizationRegister.Add(new KeyValuePair<ushort, uint>(k, v));
                }
                reader.ReadEndElement("SynchronizationRegisters");
            }
            PhysicalLayerDesynchronization = (ushort)reader.ReadElementContentAsInt("PhysicalLayerDesynchronization");
            TimeOutNotAddressedDesynchronization = (ushort)reader.ReadElementContentAsInt("TimeOutNotAddressedDesynchronization");
            TimeOutFrameNotOkDesynchronization = (ushort)reader.ReadElementContentAsInt("TimeOutFrameNotOkDesynchronization");
            WriteRequestDesynchronization = (ushort)reader.ReadElementContentAsInt("WriteRequestDesynchronization");
            WrongInitiatorDesynchronization = (ushort)reader.ReadElementContentAsInt("WrongInitiatorDesynchronization");
            BroadcastFramesCounter.Clear();
            if (reader.IsStartElement("BroadcastFramesCounters", true))
            {
                while (reader.IsStartElement("Item", true))
                {
                    ushort k = (ushort)reader.ReadElementContentAsInt("Key");
                    uint v = (uint)reader.ReadElementContentAsInt("Value");
                    BroadcastFramesCounter.Add(new KeyValuePair<ushort, uint>(k, v));
                }
                reader.ReadEndElement("BroadcastFramesCounters");
            }
            RepetitionsCounter = (ushort)reader.ReadElementContentAsInt("RepetitionsCounter");
            TransmissionsCounter = (ushort)reader.ReadElementContentAsInt("TransmissionsCounter");
            CrcOkFramesCounter = (ushort)reader.ReadElementContentAsInt("CrcOkFramesCounter");
            CrcNOkFramesCounter = (ushort)reader.ReadElementContentAsInt("CrcNOkFramesCounter");
        }
        ...
        void IGXDLMSBase.Save(GXXmlWriter writer)
        {
            if (SynchronizationRegister != null)
            {
                ...
                foreach (KeyValuePair<ushort, uint> it in SynchronizationRegister)
                {
            ...
            if (BroadcastFramesCounter != null)
            {
                ...
                foreach (KeyValuePair<ushort, uint> it in BroadcastFramesCounter)
                {
                    writer.WriteStartElement("Item");
                    writer.WriteElementString("Key", it.Key);
                    writer.WriteElementString("Value", it.Value);
