...
namespace Gurux.DLMS.Objects
{
    ...
    public class GXDLMSG3Plc6LoWPan : GXDLMSObject, IGXDLMSBase
    {
        ...
        {
            BlacklistTable = new List<GXKeyValuePair<ushort, ushort>>();
        ...
        /// </remarks>
        [XmlIgnore()]
        public ushort BroadcastLogTableEntryTtl
        {
            get;
            set;
        }
        ...
        /// </remarks>
        [XmlIgnore()]
        public List<GXKeyValuePair<ushort, ushort>> BlacklistTable
        {
            get;
            set;
        }
        ...
        /// </remarks>
        [XmlIgnore()]
        public ushort CoordShortAddress
        {
            get;
            set;
        }
        ...
        object IGXDLMSBase.GetValue(GXDLMSSettings settings, ValueEventArgs e)
        {
            ...
            if (e.Index == 12)
            {
                ...
                else
                {
                    ...
                    foreach (ushort it in GroupTable)
                    {
        ...
        void IGXDLMSBase.SetValue(GXDLMSSettings settings, ValueEventArgs e)
        {
            ...
            else if (e.Index == 10)
            {
                ...
                if (e.Value != null)
                {
                    ...
                    {
                        object[] tmp = (object[])v;
                        list.Add(new GXKeyValuePair<ushort, ushort>(Convert.ToUInt16(tmp[0]), Convert.ToUInt16(tmp[1])));
                    }
                }
                BlacklistTable = list;
            }
        ...
        private void LoadRoutingConfiguration(GXXmlReader reader)
        {
            ...
            if (reader.IsStartElement("RoutingConfiguration", true))
            {
                while (reader.IsStartElement("Item", false))
                {
                    ...
                    it.RoutingTableEntryTtl = (ushort)reader.ReadElementContentAsInt("RoutingTableEntryTtl");
                    ...
                    it.BlacklistTableEntryTtl = (ushort)reader.ReadElementContentAsInt("BlacklistTableEntryTtl");
        ...
        private void LoadRoutingTable(GXXmlReader reader)
        {
            ...
            if (reader.IsStartElement("RoutingTable", true))
            {
                while (reader.IsStartElement("Item", false))
                {
                    GXDLMSRoutingTable it = new GXDLMSRoutingTable();
                    RoutingTable.Add(it);
                    it.DestinationAddress = (ushort)reader.ReadElementContentAsInt("DestinationAddress");
                    it.NextHopAddress = (ushort)reader.ReadElementContentAsInt("NextHopAddress");
                    it.RouteCost = (ushort)reader.ReadElementContentAsInt("RouteCost");
                    ...
                    it.ValidTime = (ushort)reader.ReadElementContentAsInt("ValidTime");
                }
        ...
        private void LoadContextInformationTable(GXXmlReader reader)
        {
            ...
            if (reader.IsStartElement("ContextInformationTable", true))
            {
                while (reader.IsStartElement("Item", false))
                {
                    ...
                    it.ValidLifetime = (ushort)reader.ReadElementContentAsInt("ValidLifetime");
                }
        ...
        private void LoadBroadcastLogTable(GXXmlReader reader)
        {
            ...
            if (reader.IsStartElement("BroadcastLogTable", true))
            {
                while (reader.IsStartElement("Item", false))
                {
                    GXDLMSBroadcastLogTable it = new GXDLMSBroadcastLogTable();
                    BroadcastLogTable.Add(it);
                    it.SourceAddress = (ushort)reader.ReadElementContentAsInt("SourceAddress");
        ...
        void IGXDLMSBase.Load(GXXmlReader reader)
        {
            ...
            BroadcastLogTableEntryTtl = (ushort)reader.ReadElementContentAsInt("BroadcastLogTableEntryTtl");
            ...
            MaxJoinWaitTime = (ushort)reader.ReadElementContentAsInt("MaxJoinWaitTime");
            ...
            CoordShortAddress = (ushort)reader.ReadElementContentAsInt("CoordShortAddress");
        ...
        private void SaveBlacklistTable(GXXmlWriter writer)
        {
            if (BlacklistTable != null)
            {
                ...
                foreach (GXKeyValuePair<ushort, ushort> it in BlacklistTable)
                {
                    writer.WriteStartElement("Item");
