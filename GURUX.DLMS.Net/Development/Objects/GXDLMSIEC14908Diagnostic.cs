...
namespace Gurux.DLMS.Objects
{
    ...
    public class GXDLMSIEC14908Diagnostic : GXDLMSObject, IGXDLMSBase
    {
        ...
        /// </summary>
        [XmlIgnore()]
        public ushort UnexpectedPlcCommandCount
        {
            get;
            set;
        }
        ...
        /// </summary>
        [XmlIgnore()]
        public ushort BacklogOverflows
        {
            get;
            set;
        }
        ...
        /// </summary>
        [XmlIgnore()]
        public ushort FrequencyInvalid
        {
            get;
            set;
        }
        ...
        void IGXDLMSBase.SetValue(GXDLMSSettings settings, ValueEventArgs e)
        {
            ...
            {
                NoReceiveBuffer = (ushort)e.Value;
            }
            else if (e.Index == 6)
            {
                TransmitNoData = (ushort)e.Value;
            }
            else if (e.Index == 7)
            {
                UnexpectedPlcCommandCount = (ushort)e.Value;
            }
            else if (e.Index == 8)
            {
                BacklogOverflows = (ushort)e.Value;
            }
            else if (e.Index == 9)
            {
                LateAck = (ushort)e.Value;
            }
            else if (e.Index == 10)
            {
                FrequencyInvalid = (ushort)e.Value;
            }
            else if (e.Index == 11)
            {
        ...
        void IGXDLMSBase.Load(GXXmlReader reader)
        {
            ...
            NoReceiveBuffer = (ushort)reader.ReadElementContentAsInt("NoReceiveBuffer");
            TransmitNoData = (ushort)reader.ReadElementContentAsInt("TransmitNoData");
            UnexpectedPlcCommandCount = (ushort)reader.ReadElementContentAsInt("UnexpectedPlcCommandCount");
            BacklogOverflows = (ushort)reader.ReadElementContentAsInt("BacklogOverflows");
            LateAck = (ushort)reader.ReadElementContentAsInt("LateAck");
            FrequencyInvalid = (ushort)reader.ReadElementContentAsInt("FrequencyInvalid");
            PlcTestRate = (ushort)reader.ReadElementContentAsInt("PlcTestRate");
        }
